...
else if (!empty($_POST["logout"]) && $_POST["logout"] == "yes")  session_destroy() ;
...
<form action="hw6.php" method="post"><pre>
SIGN UP
...
<form action="hw6.php" method="post" enctype='multipart/form-data'><pre>
...
Please sleet txt file only <br> <input type='file' name='file_content'> <br> <input type="submit" value="Upload">
